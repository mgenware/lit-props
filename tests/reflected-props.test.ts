...
it('reflected object', async () => {
  ...
  const el = (await fixture(html`
    <t-object-r prop="{&#x22;id&#x22;: 321}"></t-object-r>
  `)) as T;
...
it('reflected array', async () => {
  ...
  const el = (await fixture(html`
    <t-array-r prop="[1,2,false,true]"></t-array-r>
  `)) as T;
